...
#             1)  LLR6 model using all patients,
#             2)  LLR5noPSTH model using all patients,
#             3)  LLR6 model using non-NSCLC patients
#             with 10k-repeat train-test splitting (80%:20%).
#
#Run command, e.g.: python ParamCalculate.py LLR6 all
###############################################################################################
