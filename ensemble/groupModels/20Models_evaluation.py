...
#Description: To evaluate  machine learning model performance using 2000-repeated 5-fold cross validation.
#
...
if __name__ == "__main__":
    ...
    phenoNA = 'Response'
    if MLM ==  'RNAseq_avail':
        featuresNA = {"Mutation_wildtype_ratio": ['Expression_R','Kyte_Doolittle_R','Hopp_Woods_R','HMC_R','ARFR'],
                    "Physicochemical_properties": ['PREDIVAC-TAP','TAPPred','SMM-TAP','PeptideCutter','Proteome Discoverer','netchop'],
                    "Sequence_similarity": ['Kyte_Doolittle_R','Hopp_Woods_R','HMC_R','ARF','instability_index','Isoelectric_point'],
                    "Binding_dynamics": ['PRIME','Neoantigen_fitness','NetMHCpanExp','MHCflurry','IEDBi','MixMHCpred'],
                    "Protein_processing": ['HLA_evolutionary_divergence','Self_semi','BLAST','Diamond','PSS'],
                    "Advanced_prediction_model": ['netMHCpan_aff','MHCflurry_aff','IEDB_aff','NetMHCstab_sta','StabilitySeq_sta'],
                    "Related_gene_expression": ['genes'],
                    "Gene_related_score": ['CYTs','MCPc']}
    else
        featuresNA = {
                    "Mutation_wildtype_ratio": ['Kyte_Doolittle_R','Hopp_Woods_R','HMC_R','ARFR'],
                    "Physicochemical_properties": ['PREDIVAC-TAP','TAPPred','SMM-TAP','PeptideCutter','Proteome Discoverer','netchop'],
                    "Sequence_similarity": ['Kyte_Doolittle_R','Hopp_Woods_R','HMC_R','ARF','instability_index','Isoelectric_point'],
                    "Binding_dynamics": ['PRIME','Neoantigen_fitness','NetMHCpanExp','MHCflurry','IEDBi','MixMHCpred'],
                    "Protein_processing": ['HLA_evolutionary_divergence','Self_semi','BLAST','Diamond','PSS'],
